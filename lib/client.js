...
function MoveInSettings({ t }) {
  ...
  const [selected, setSelected] = (0, import_react.useState)(() => /* @__PURE__ */ new Set(["skills"]));
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: "dmi-page", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("fieldset", { className: "dmi-block", style: { borderLeft: 0, borderRight: 0, borderTop: 0, margin: 0 }, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "dmi-grid", children: CATEGORIES.map((id) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { className: "dmi-choice", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { type: "checkbox", disabled: busy, checked: selected.has(id), onChange: () => toggle(id) }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: t(id) })
      ] }, id)) }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "dmi-hint", children: t("firstTry") })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("details", { className: "dmi-details", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "dmi-origins", children: ["claude", "codex", "opencode"].map((id) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { className: "dmi-origin", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { type: "radio", name: "dmi-origin", disabled: busy, checked: origin === id, onChange: () => {
          setOrigin(id);
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dmi-actions", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { className: "dmi-button dmi-primary", type: "button", disabled: !canApply || include.length === 0, onClick: () => run(true), children: t("apply") }),
    ...
    result && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: "dmi-result", "aria-live": "polite", children: [
      ...
      result.ok && result.applied && result.actions.some((action) => action.status === "done") && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dmi-block", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: t("nextTitle") }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "dmi-hint", children: t("nextSteps") }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", { href: "https://github.com/sjh9714/dsh-movein/blob/main/docs/first-task.md", target: "_blank", rel: "noreferrer", children: t("firstTask") })
      ] }),
