...
export function renderReport(scanResult, actions, { apply }) {
  ...
  if (counts.agents) L.push('  ○ subagents, not moved yet (planned, convert to skills)');
  if (scanResult.permissionRules) L.push('  ○ permission rules, not moved yet (planned, tools/pre-execute bridge)');
